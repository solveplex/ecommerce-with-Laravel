...
<div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Product Order List</h4> </div>
                                ...
                                <table class="table product-overview" id="myTable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Varun Dhavan</td>
                                            <td>#95457898</td>
                                            <td> <img src="../plugins/images/chair2.jpg" alt="iPhone" width="80"> </td>
                                            <td>Wooden Chair</td>
                                            <td>25</td>
                                            <td>09-7-2017</td>
                                        ...
                                        <tr>
                                            <td>Ritesh Desh</td>
                                            <td>#68457898</td>
                                            <td> <img src="../plugins/images/chair3.jpg" alt="apple_watch" width="80"> </td>
                                            <td>Gray Chair</td>
                                            <td>12</td>
                                            <td>08-7-2017</td>
                                            <td> <span class="label label-success font-weight-100">Paid</span> </td>
                                        ...
                                        <tr>
                                            <td>Hrithik</td>
                                            <td>#45457898</td>
                                            <td> <img src="../plugins/images/chair4.jpg" alt="mac_mouse" width="80"> </td>
